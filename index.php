            ...
            <div class="navbar">
                ...
                <nav>
                    <ul>
                        ...
                        <li><a href="#my-footer"><b>About</b></a></li>
                        <li class="nav-item dropdown">
                            ...
                            <b style=" color: rgb(250, 248, 248);">  More...</b>
                            </a>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                              <li><a class="dropdown-item" href="cart2.php">Your Orders</a></li>
                ...
                <div class="navbar">
                    ...
                    <form class="d-flex" action="" method="GET"  style="height:40px;">
                        <input class="form-control me-2 " style="padding: top 0px;"required type="search" value="<?php if(isset($_GET['Search'])){echo $_GET['Search'];} ?>" placeholder="Search" aria-label="Search" name="Search" id="Search" style="width:20vw;">
                        <a href="#mysearch"><button  style="background: radial-gradient(#fff,#8a7e7e); border-radius:10px; padding: top 10px;border: none; "  type="sumbit"> <img src="images/search_logo.png" alt="" width="30px" ></button></a>&nbsp;&nbsp;
...
<symbol id="exclamation-triangle-fill" fill="currentColor" viewBox="0 0 16 16">
 <path d="M8.982 1.566a1.13 1.13 0 0 0-1.96 0L.165 13.233c-.457.778.091 1.767.98 1.767h13.713c.889 0 1.438-.99.98-1.767L8.982 1.566zM8 5c.535 0 .954.462.9.995l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 5.995A.905.905 0 0 1 8 5zm.002 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
    ...
    ?>
            ...
            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel" style=" padding-top: 90px;">
    ...
    <br>
            ...
            <?php
            echo'
            <h5 class="title" padding-top: 50px; >Featured Products</h5>
        
            <!-- **** featured products part2 -->
            <div class="backgroundcolor" style=" background-color: rgb(235, 229, 220);">
                 <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel" style=" margin-left: 150px; padding-top: 50px; max-width: 300%; background-color: rgb(235, 229, 220);">
...
<div class="modal fade" id="accountModal" tabindex="-1" aria-labelledby="accountModalLabel" aria-hidden="true">
  ...
  echo '
            ...
            <div class="col-4">
                  <img src='.$row['image'].' alt="" class="show" id='.$row['image'] .'>
                  <h4>'.$row['name'].'</h4>
                  <div class="rating">
                    <i class="fa fa-star" ></i>
                   <i class="fa fa-star" ></i>
                  ...
                  <small>M.R.P: <s>'.$row['price'].'</s></small>
                  <p>'.$row['newprice'].'</p>
    ...
    <?php
    if(isset($_GET['Search'])){
        echo '<div class="small-container" id="mysearch">
        <h5 class="title">Searched Products</h5>
        <div class="row">';
        $filtervalue=$_GET['Search'];
 $filtervalue='%'.$filtervalue.'%';
 
      $sql = 'SELECT * FROM productlist4 WHERE price LIKE "'.$filtervalue.'" or newprice LIKE "'.$filtervalue.'" or name LIKE "'.$filtervalue.'"  ';
    ...
    <div class="footer" id="my-footer">
            ...
            <div class="row">
                ...
                <div class="col-4" style="padding-left:40px; margin-top:-30px;">
                    <h3>Useful Links</h3>
